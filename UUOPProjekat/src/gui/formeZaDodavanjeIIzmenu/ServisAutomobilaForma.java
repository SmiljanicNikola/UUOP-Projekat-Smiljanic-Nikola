...
public class ServisAutomobilaForma extends JFrame {
	...
	private JTextField txtServisiraniAutomobil = new JTextField(20);
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (validacija()) {
					...
					String korisnickoIme = txtServiser.getText().trim();
	...
	private void popuniPolja() {
		...
		txtServiser.setText(String.valueOf(servisautomobila.getServiser()));
