...
public class LoginProzorServiser extends JFrame {
	...
	public LoginProzorServiser(CRUDOperacije crudoperacije) {
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(korisnickoIme.equals("") || sifra.equals("")) {
					...
					Serviser prijavljeniServiser = crudoperacije.loginServiser(korisnickoIme, sifra);
